  ...
  experience: [
    {
      ...
      summary: {
        ru: "Роботизированный Массажный Комплекс «Роден» (HealthTech / MedTech, B2B/B2C) — аппаратно-программный комплекс (Hardware + Software + Robotics + AI/CV): облачное ПО, внутреннее ПО для разработки, 2 Android-приложения.\nСтек: Python, C++, C#, JavaScript, CUDA, Unity.",
      ...
      highlights: [
        ...
        { ru: "Взаимодействие с клиентами, проведение исследований, анализ обратной связи - Собрал и организовал ОС от 400+ B2C-клиентов, которую завалидировал на 20+ CustDev-интервью. Результат: рост CSI с 8.3 до 8.9 и NPS +10%", en: "Client engagement, research and feedback analysis — gathered and organised feedback from 400+ B2C clients, validated on 20+ CustDev interviews. Result: CSI grew from 8.3 to 8.9, NPS +10%." },
